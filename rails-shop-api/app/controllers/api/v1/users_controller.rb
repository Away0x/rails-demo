class Api::V1::UsersController < ApplicationController
  ...
  private
    ...
    def serializer_user(user, error_code=0, message='ok', options={})
      # 如果 NameError: uninitialized constant Api::V1::UsersController::UserSerializer
      # 需要执行 spring stop (https://stackoverflow.com/questions/60688928/rails-nameerror-uninitialized-constant-userserializer)
